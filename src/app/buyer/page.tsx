...
const steps = [
  {
    ...
    description: "Supporting you through closing and transition.",
  },
  {
    title: "Target Identification",
    description:
      "Leverage our network to find roofing businesses that fit your strategy.",
  },
  {
    title: "Due Diligence",
    description:
      "Evaluate financial health, operational efficiency, and market position.",
  },
  {
    title: "Negotiation",
    description:
      "Secure fair terms and advocate on your behalf to get the best deal.",
  },
  {
    title: "Closing",
    description: "Manage the transaction process from start to finish.",
  },
  {
    title: "Transition Support",
    description:
      "Provide guidance to ensure a smooth integration and successful handover.",
  },
];
    ...
    <section className='mhWrapper flex-col'>
      ...
      <article className='container'>
        <div className='p-4 sm:p-6 animate-fadeInUp'>
          <h1 className='text-4xl pb-4'>
            Acquire Roofing Businesses with Confidence
          </h1>
          <p className='text-lg max-w-2xl leading-relaxed opacity-90 pb-3'>
            We help investors and operators identify, evaluate, and acquire
            high-quality roofing companies. Our disciplined process simplifies
            acquisitions and helps you secure the right opportunity with
            confidence.
          </p>
          <p className='text-lg max-w-2xl leading-relaxed opacity-90'>
            If you&apos;re looking to buy a roofing business, our team provides
            the expertise and process to help you identify and acquire the right
            opportunity.
          </p>
        </div>
      </article>
      ...
      <article className='container p-4 sm:p-6 animate-fadeInUp'>
        <div className='flex flex-col items-start gap-3 max-w-xs'>
          ...
          <p className='text-sm opacity-60'>
            All conversations are confidential and tailored to your acquisition
            goals.
          </p>
        </div>
      </article>
      ...
      <article className='container p-4 sm:p-6 animate-fadeInUp'>
        ...
        <p className='text-lg max-w-2xl leading-relaxed opacity-90 pb-6'>
          Acquiring a roofing business is one of the fastest ways to grow your
          company, expand market share, and increase profitability. If
          you&apos;re looking to buy a roofing business, our team helps you
          identify the right opportunities and navigate the process with
          confidence.
        </p>
      ...
      {isLoggedIn && <Dashboard hasFilters />}
    </section>
  );
};
